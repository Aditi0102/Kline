...
export const getAllUsers = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${allUrls.backend_url}/api/v1/admin/users`);
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${allUrls.backend_url}/api/v1/admin/user/${id}`);
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${allUrls.backend_url}/api/v1/admin/user/${id}`);
